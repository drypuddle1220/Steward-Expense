...
import { LineChart, Line, XAxis, YAxis, Tooltip, CartesianGrid, PieChart, Pie, Legend, Cell } from 'recharts';
...
export default class Visualizer extends React.Component {
    prepareLineChartData() {
        ...
        return [...incomeData, ...expenseData].sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
      }
      ...
      render() {
        ...
        return (
            ...
            <div className="card"> {/* Card for Line Chart */}
            ...
            <div className="card"> {/* Card for Pie Chart */}
